    ...
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<Usuario> Crear(Usuario entidad, Stream Foto = null, string NombreFoto = "", string UrlPlantillaCorreo = "")
        {
            ...
            try
            {
                ...
                if (UrlPlantillaCorreo != "")
                {
                    ...
                    //OBETENEMOS RESPUESTA DE LA SOLICITUD
                    HttpWebRequest request = (HttpWebRequest)WebRequest.Create(UrlPlantillaCorreo);
                    HttpWebResponse response = (HttpWebResponse)request.GetResponse();

                    //validamos estado de la solicitud
                ...
                //Para obtener el rol que tienen
                usuario_creado = query.Include(r => r.IdRolNavigation).First();  //.First() =>> Devuelve el primero que encuentre
        ...
        public async Task<bool> RestablecerClave(string Correo, string UrlPlantillaCorreo)
        {
            try
            {
                ...
                if (htmlCorreo != "")
                    correo_enviado = await _correoService.EnviarCorreo(usuario_encontrado.Correo, "Contraseña Restablecida", htmlCorreo);
